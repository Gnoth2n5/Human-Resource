                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="job_titlle"
                                                value="{{ Request()->job_titlle }}"placeholder="Tiêu Đề Công Việc">
                                        </div>

                                        <div class="form-group col-md-3">
                                            <label>Mức Lương Tối Thiểu</label>
                                            <input type="text" class="form-control" name="min_salary"
                                                value="{{ Request()->min_salary }}"placeholder="Mức Lương Tối Thiểu">
                                        </div>

                                        <div class="form-group col-md-3">
                                            <label>Mức Lương Tối Đa</label>
                                            <input type="text" class="form-control" name="max_salary"
                                                value="{{ Request()->max_salary }}"placeholder="Mức Lương Tối Đa">
                                        </div>
