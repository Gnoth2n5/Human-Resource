            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form  class="form-horizontai" method="post" accept="admin/jobs/add" enctype="multipart/form-data">
                            {{csrf_field()}}
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" value="{{old('min_salary')}}" name="min_salary" class="form-cpntrol" required placeholder="Nhập Mức Lương Tối Thiểu" id="min_salary">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" value="{{old('max_salary')}}" name="max_salary" class="form-cpntrol" required placeholder="Nhập Mức Lương Tối Đa" id="max_salary">
