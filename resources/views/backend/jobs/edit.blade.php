                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" value="{{$getRecord->min_salary}}" name="min_salary" class="form-cpntrol" required placeholder="Nhập Mức Lương Tối Thiểu">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" value="{{$getRecord->max_salary}}" name="max_salary" class="form-cpntrol" required placeholder="Nhập Mức Lương Tối Đa">
