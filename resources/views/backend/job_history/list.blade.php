                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 d-flex justify-content-end">
                        ...
                        <form action="{{ url('admin/job_history/export') }}" method="get">
                            ...
                            <a href="{{ url('admin/job_history/export?start_date=').Request::get('start_date'). '&end_date'. Request::get('end_date') }}" class="btn btn-success">Excel Export</a>
                        </form>
                        <br>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="job_titlle" class="form-control" placeholder="Job Title" value="{{ Request()->job_titlle }}">
                                </div>
