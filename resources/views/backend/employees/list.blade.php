    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <section class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                       <h3 class="card-title">Tìm kiếm nhân sự</h3>
                    </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="form-group col-md-3">
                            <label >Tên</label>
                            <input type="text" class="form-control" name="name" value="{{Request()->name}}"placeholder="Tên">
                          </div>
                          <div class="form-group col-md-3">
                            <label >Họ</label>
                            <input type="text" class="form-control" name="last_name"value="{{Request()->last_name}}" placeholder="họ">
                          </div>
                          <div class="form-group col-md-3">
                            <label >Email</label>
