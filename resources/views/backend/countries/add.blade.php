            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form  class="form-horizontai" method="post" accept="admin/countries/add" enctype="multipart/form-data">
                            {{csrf_field()}}
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-lable">Country Name <span style="color: red">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{old('country_name')}}" name="country_name" class="form-control" required placeholder="Enter Country Name">
