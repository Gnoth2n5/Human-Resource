            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form  class="form-horizontai" method="post" accept="admin/manager/edit/" enctype="multipart/form-data">
                            {{csrf_field()}}
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-lable">Tên quản lý <span style="color: red">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{$getRecord->manager_name}}" name="manager_name" class="form-control" required placeholder="Nhập Tên Quản Lý">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" value="{{$getRecord->manager_email}}" name="manager_email" class="form-control" required placeholder="Nhập Email Quản Lý">
    
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-lable">SĐT quản lý <span style="color: red">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="number" value="{{$getRecord->manager_mobile}}" name="manager_mobile" class="form-control" required placeholder="Nhập SĐT Quản Lý">
