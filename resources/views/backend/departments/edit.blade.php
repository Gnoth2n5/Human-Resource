            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form  class="form-horizontai" method="post" accept="admin/departments/edit/" enctype="multipart/form-data">
                            {{csrf_field()}}
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-lable">Tên phòng <span style="color: red">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{$getRecord->department_name}}" name="department_name" class="form-cpntrol" required placeholder="Nhập tên phòng">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                   <select name="manager_id"  class="form-control" required>
                                    <option {{($getRecord->manager_id)==1 ?'select':''}} value="1">Thông</option>
                                    <option {{($getRecord->manager_id)==2 ?'select':''}} value="2">Thông 2</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                   <select name="locations_id"  class="form-control" >
                                    ...
                                    <option {{($value->id==$getRecord->locations_id)?'select':''}} value="{{ $value->id }}">{{ $value->street_address }}</option>
                                @endforeach
