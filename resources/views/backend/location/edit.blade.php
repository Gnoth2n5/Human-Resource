                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Sửa Vị Trí</h3>
                        </div>
                        <form class="form-horizontal" method="post" action="{{ url('admin/locations/edit/' . $getRecord->$id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="card-body">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-lable">Địa chỉ đường <span style="color: red">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{$getRecord->street_address}}" name="street_address" class="form-cpntrol" required placeholder="Nhập Đường">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" value="{{$getRecord->postal_code}}" name="postal_code" class="form-cpntrol" required placeholder="Nhập Mã Bưu Điện">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{$getRecord->city}}" name="city" class="form-cpntrol" required placeholder="Nhập Thành Phố">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{$getRecord->state_province}}" name="	state_province" class="form-cpntrol" required placeholder="NhậpThành phố">
