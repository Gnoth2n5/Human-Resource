            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 d-flex justify-content-end">
                        ...
                        <a href="{{ url('admin/locations/add') }}" class="btn btn-primary mx-2">Thêm Địa Điểm</a>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" name="street_address" class="form-control"
                                                value="{{ Request()->street_address }}" placeholder="Nhập đại chỉ đường">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Mã bưu điện</label>
                                            <input type="text" name="postal_code" class="form-control"
                                                value="{{ Request()->postal_code }}" placeholder="Mã bưu điện">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Thành phố</label>
                                            <input type="text" name="city" class="form-control"
                                                value="{{ Request()->city }}" placeholder="Nhập thành phố">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Tỉnh</label>
                                            <input type="text" name="state_province" class="form-control"
                                                value="{{ Request()->state_province }}" placeholder="Nhập tỉnh">
                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/locations/delete', $value->id) }}"
                                                        ...
                                                        onclick="return confirm('Bạn có chắc muốn x')">Sửa</a>
