            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form  class="form-horizontai" method="post" accept="admin/position/add"  enctype="multipart/form-data">
                            {{csrf_field()}}
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-lable">Tên chức vụ<span style="color: red">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{old('position_name')}}" name="position_name" class="form-control" required placeholder="Nhập Tên Chức Vụ">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" value="{{old('working_days_per_month')}}" name="working_days_per_month" class="form-control" required placeholder="Nhập Ngày làm trong tháng">
                                </div>
                            </div> <!-- Đóng div bị thiếu -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" value="{{old('daily_rate')}}" name="daily_rate" class="form-control" required placeholder="Nhập Lương Theo Ngày">
                                </div>
                            </div> <!-- Đóng div bị thiếu -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" value="{{old('monthly_rate')}}" name="monthly_rate" class="form-control" required placeholder="Nhập Lương Theo Tháng">
                                </div>
                            </div> <!-- Đóng div bị thiếu -->
